...
.stack 100h
.data
    enter db 'Enter Reg. No: ','$'
    regno db '1234',13
    rlength db 05h
    input db 10 dup(?)
    sname db 10,13,'Name: Tyrion Lannister','$'
    error db 10,13,'Not Enrolled','$'
...
.code
    ...
    main proc
        ...
        lea di,input
        xor cx,cx
        mov cl,rlength   ;the length of registration number. we have to compare each character only 'cx' times
