...
public class GUIServer extends javax.swing.JFrame {
  ...
  static DataOutputStream dout;
    ...
    private void initComponents() {
        ...
        msg_area.setBackground(new java.awt.Color(0, 102, 102));
        msg_area.setColumns(20);
        msg_area.setFont(new java.awt.Font("MS Mincho", 3, 13)); // NOI18N
        msg_area.setForeground(new java.awt.Color(255, 204, 0));
        msg_area.setRows(5);
    ...
    {
      msg_area.setText(msg_area.getText().trim()+"\nClient is offline. Message cannot be sent: ");
    }
    }
